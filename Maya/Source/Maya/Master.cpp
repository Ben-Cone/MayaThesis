...
void AMaster::MoveCube(FVector masterCurrentLocation)
{
	SetActorLocation(masterCurrentLocation, false);
	currentLocation = masterCurrentLocation;
}
...
void AMaster::Movement_A_LinearPulse()
{
	...
	//interpValue = (Curve->InterpAlongCurve(lengthSeconds, timeDelta, 0) * distanceMultiplier);
